...
<a class="carousel-control-next" href="#demo" data-slide="next">
  <span class="carousel-control-next-icon"></span>
		...
		<div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style={{visibility: 'visible', animation: '0.5s', animationname: 'slideInRight'}}>
					...
					<div class="occasional">
						<h5>Types :</h5>
						<div class="colr ert">
							<label class="radio"><input type="radio" name="radio" defaultChecked=""/><i></i>Casual Shoes</label>
						</div>
						<div class="colr">
				...
				<div class="bootstrap-tab animated wow slideInUp animated" data-wow-delay=".5s" style={{visibility: 'visible', animation: '0.5s', animationname: 'slideInUp'}}>
								...
								<div class="bootstrap-tab-text-grids">
									...
									<div class="add-review">
										...
										<form>
											...
											<textarea type="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message...';}" required="" value="Message..."></textarea>
